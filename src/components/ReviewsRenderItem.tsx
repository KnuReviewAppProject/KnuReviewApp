...
interface ReviewsRenderItemProps {
  data: Review;
  userStats: {reviews: number; good: number; bad: number};
}

const ReviewsRenderItem: React.FC<ReviewsRenderItemProps> = ({
  data,
  userStats,
}) => {
  // Logic
          ...
          <View
            ...
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              <Text style={{fontSize: 12, marginRight: 5, color: '#7a7a7a'}}>
                리뷰 {userStats.reviews || 0}개
              </Text>
              <Text style={{fontSize: 12, marginRight: 5, color: '#7a7a7a'}}>
                추천 {userStats.good || 0}개
              </Text>
              <Text style={{fontSize: 12, marginRight: 5, color: '#7a7a7a'}}>
                비추천 {userStats.bad || 0}개
              </Text>
            </View>
          </View>
        </View>
